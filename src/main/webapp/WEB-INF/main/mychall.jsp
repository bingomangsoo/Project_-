...
<body>
  ...
  <div class="imguriking">
		...
		<h4 style="position: absolute; left: 10%; top: 205%"><strong>😀오늘하루 체크카드</strong></h4>

		<p style="position: absolute; left: 14%; top: 213%">
			- [EAT] 커피 5% 캐시백<br>- [EAT] 배달/주문 5% 캐시백
		</p>
		<a href="https://www.card-gorilla.com/card/detail/762"
			style="position: absolute; left: 30%; top: 225%">자세히보기</a>

		<h4 style="position: absolute; left: 63%; top: 205%"><strong>😍노리 체크카드</strong></h4>
		<p style="position: absolute; left: 68%; top: 213%">
			- 커피 20% 할인<br>- 배달앱 5% 할인<br>- 온라인 쇼핑 5% 할인
		</p>
	</div><a href="https://www.card-gorilla.com/card/detail/762" style="position: absolute;left: 83%; top:225%">자세히보기</a>
